...
void TepeIDTest()
{
    std::cout << "id"
              << "\n";
    std::cout << "int:" << TypeIDGenerator<int>::m_id() << "\n";
    std::cout << "int:" << TypeIDGenerator<int>::m_id() << "\n";
    std::cout << "float:" << TypeIDGenerator<float>::m_id() << "\n";
    std::cout << "std::vector<float>:" << TypeIDGenerator<std::vector<float>>::m_id() << "\n";
    std::cout << "std::tuple<float, int>:" << TypeIDGenerator<std::tuple<float, int>>::m_id() << "\n";
    std::cout << "std::tuple<float, int>:" << TypeIDGenerator<std::tuple<float, int>>::m_id() << "\n";
    std::cout << "std::tuple<int, float>:" << TypeIDGenerator<std::tuple<int, float>>::m_id() << "\n";
    std::cout << "int:" << TypeIDGenerator<int>::m_id() << "\n";
    std::cout << "int*:" << TypeIDGenerator<int*>::m_id() << "\n";
    std::cout << "int*:" << TypeIDGenerator<int*>::m_id() << "\n";
    std::cout << "int&:" << TypeIDGenerator<int&>::m_id() << "\n";
    ...
    constexpr auto CdId_int_type_list = CdIdGenerator<decltype(int_type_list)>::m_id();
